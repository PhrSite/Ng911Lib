...
namespace I3LogEvents
{
    ...
    public class SubscribeLogEvent : LogEvent
    {
        ...
        /// <summary>
        /// Contains the URI or FQDN of the other party.
        /// Required
        /// </summary>
        public string peer { get; set; }

        /// <summary>
        /// Contains an array of any parameters from the SUBSCRIBE request.
        /// Required.
        /// </summary>
        public List<SubParamsType> parameter = new List<SubParamsType>();

        /// <summary>
        /// Set to the final expiration time negotiated.
        /// Required
        /// </summary>
        public int expiration { get; set; }

        /// <summary>
        /// Contains the response code sent to the SUBSCRIBE request.
        /// Required.
        /// </summary>
