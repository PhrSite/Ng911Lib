...
namespace I3LogEvents
{
    ...
    public class PolicyChangeLogEvent : LogEvent
    {
        ...
        /// <summary>
        /// Identifies the owner of the policy.
        /// Required.
        /// </summary>
        ...
        /// <summary>
        /// Contains the policy content as a JSON string.
        /// Required.
        /// </summary>
        public string policyContent { get; set; }

        /// <summary>
        /// Identifies the policy store the the policy is stored in.
        /// Required.
        /// </summary>
        public string policyStoreId { get; set; }

        /// <summary>
        /// Identifies the application that made the change.
        /// Required.
        /// </summary>
