/////////////////////////////////////////////////////////////////////////////////////
//  File:   RecMediaStartLogEvent.cs                                13 Jan 23 PHR
/////////////////////////////////////////////////////////////////////////////////////

namespace I3V3.LogEvents
{
    /// <summary>
    /// Data class for the RecMediaStartLogEvent log event. See Sections 4.12.3.7 and E.8.1 of 
    /// NENA-STA-010.3.
    /// Logged by a media recorder when a media session starts.
    /// </summary>
    public class RecMediaStartLogEvent : LogEvent
    {
        ...
        /// <summary>
        /// Set to “incoming” for media streams that the are received or “outgoing” for media streams that 
        /// are sent. Required.
        /// </summary>
